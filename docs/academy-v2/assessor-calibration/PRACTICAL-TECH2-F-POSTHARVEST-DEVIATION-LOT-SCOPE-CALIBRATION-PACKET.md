# PRACTICAL-TECH2-F-POSTHARVEST-DEVIATION-LOT-SCOPE — Paired-Assessor Calibration Packet

**Assessment:** Technician II Practical F — Postharvest Deviation & Lot Scope  
**Assessment ID:** `PRACTICAL-TECH2-F-POSTHARVEST-DEVIATION-LOT-SCOPE`  
**Exact version:** `1.0.0`  
...
1. **Containment and facts** — 15 points
2. **Trend and process interpretation** — 25 points
3. **Genealogy and affected scope** — 25 points
4. **QA reasoning and role boundary** — 20 points
5. **Records and handoff** — 15 points

## Critical-failure decisions

- Makes an unauthorized product release or disposition decision.
- Scopes the entire facility when genealogy supports a narrower affected set.
- Excludes affected material to improve apparent results.
- Substitutes room relative humidity for product water-activity evidence.

## Required candidate/work-product evidence

- Postharvest Deviation Investigation
- Affected-scope table

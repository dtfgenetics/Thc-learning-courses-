# Practical E — Canopy Maintenance Work Order

**Credential:** THC Cultivation Technician I  
**Mode:** annotated simulation, supervised plant lab, or approved workplace equivalent  
**Primary tasks:** `TASK-CULT-CANOPY-001`, `TASK-CULT-SANITATION-001`, `TASK-CULT-OBSERVE-001`, `TASK-CULT-RECORDS-001`
...
- room/batch/cultivar information
...
- one severely stressed plant
- ambiguous tissue-removal instruction requiring clarification
- branch that would require excessive tension
- fresh pest sign discovered during work
...
1. Verify room, batch, stage and work-order objective.
2. Identify which plants or conditions require exception handling before work begins.
3. Prepare clean tools/support material.
4. Select the least disruptive action that satisfies the work order.
...
- work-order/objective interpretation: 15
- pre-task crop inspection: 10
- sanitation/workspace control: 15
- task execution and tissue preservation: 25
- consistency against criteria: 15
- exception/escalation handling: 10
- records/handoff: 10

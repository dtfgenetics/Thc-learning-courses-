...
| 420-catalog reference resource | `content/resources/` | Must preserve its `THC-C###` legacy alias |
...
## 3. Wire a course slice in dependency order
...
## 4. Status and publication rules
...
## 5. Downloads and printable tools

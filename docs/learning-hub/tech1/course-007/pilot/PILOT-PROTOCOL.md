# Pilot Protocol — Integrated Cultivation Technician Practice Lab

**Course:** `COURSE-LH-TECH1-007`  
...
- exact course ID and version: `COURSE-LH-TECH1-007`;
- source commit SHA;
...
**Mapped performance evidence:** PRACTICAL-TECH1-A through PRACTICAL-TECH1-F plus CAPSTONE-TECH1-ONE-CULTIVATION-SHIFT

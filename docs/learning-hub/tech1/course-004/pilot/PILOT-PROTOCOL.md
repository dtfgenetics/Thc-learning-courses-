# Pilot Protocol — Water, Root Zone, Nutrition & Irrigation Fundamentals

**Course:** `COURSE-LH-TECH1-004`  
...
- exact course ID and version: `COURSE-LH-TECH1-004`;
- source commit SHA;
...
**Mapped performance evidence:** PRACTICAL-TECH1-B

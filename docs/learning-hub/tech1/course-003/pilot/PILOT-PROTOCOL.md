# Pilot Protocol — Environmental, Light & Sensor Fundamentals

**Course:** `COURSE-LH-TECH1-003`  
...
- exact course ID and version: `COURSE-LH-TECH1-003`;
- source commit SHA;
...
**Mapped performance evidence:** Canonical Technician I practical evidence mapped by the current Course 3 package

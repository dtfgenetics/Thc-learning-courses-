# Pilot Protocol — Plant Observation, Growth Stages & Crop Records

**Course:** `COURSE-LH-TECH1-002`  
...
- exact course ID and version: `COURSE-LH-TECH1-002`;
- source commit SHA;
...
**Mapped performance evidence:** PRACTICAL-TECH1-A

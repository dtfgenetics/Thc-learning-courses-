...
This file records the current production drafts created from the Course 1 visual-reference system. Full-resolution PNG masters are stored in Google Drive under:
...
1. `VIS-LH-TECH1-001-04-SDS-ANATOMY`
2. `VIS-LH-TECH1-001-05-CONTAMINATION-ROUTES`
3. `VIS-LH-TECH1-001-06-CLEAN-DIRTY-FLOW`
4. `VIS-LH-TECH1-001-07-SANITATION-SEQUENCE`
5. `VIS-LH-TECH1-001-08-AUTHORITY-ESCALATION`
6. `VIS-LH-TECH1-001-09-CONTROLLED-DOCUMENT`
7. `VIS-LH-TECH1-001-10-GENEALOGY`
8. `VIS-LH-TECH1-001-11-MOVEMENT-RECORD`
9. `VIS-LH-TECH1-001-12-RECONCILIATION`
10. `VIS-LH-TECH1-001-13-EQUIPMENT-PREUSE`
11. `VIS-LH-TECH1-001-14-OPERATOR-VS-MAINTENANCE`
12. `VIS-LH-TECH1-001-15-FAULT-REPORT`
13. `VIS-LH-TECH1-001-16-RECORD-CORRECTION`
14. `VIS-LH-TECH1-001-17-SHIFT-HANDOFF`
15. `VIS-LH-TECH1-001-18-INTEGRATED-WORKFLOW`

Generated-image text is not treated as authoritative instructional copy. Before learner publication, every graphic must be reconciled against the canonical lesson text, authoritative sources, Course 1 authorization boundaries, and WCAG-oriented text alternatives.

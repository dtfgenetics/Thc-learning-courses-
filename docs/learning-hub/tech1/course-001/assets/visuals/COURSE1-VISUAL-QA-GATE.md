...
| `06-CLEAN-DIRTY-FLOW` | 2.1 | preferred-review-candidate | Rebuilt candidate now states that movement patterns depend on facility design, zone map and SOPs. Final learner copy must keep all zone labels and directional flow clearly illustrative rather than universal. Rebuild reference board in Drive: `course1-visual-blocker-rebuild-board-v1.png` (`1qzh2JHuHuIemiKktd-tLWw8XhWqpL4Lt`). |
| `07-SANITATION-SEQUENCE` | 2.2 | preferred-review-candidate | Rebuilt candidate now includes preparation, cleaning before sanitizer, approved/labeled product use, controlled contact conditions, finish-as-applicable, inspection and documentation. Final learner version must preserve exact-product/preparation language and avoid implying a rinse/dry step applies universally. Rebuild reference board in Drive: `course1-visual-blocker-rebuild-board-v1.png` (`1qzh2JHuHuIemiKktd-tLWw8XhWqpL4Lt`). |
...
| `12-RECONCILIATION` | 4.3 | preferred-review-candidate | Rebuilt candidate explicitly separates count, compare, investigate, document and resolve-as-authorized; it prohibits forced balancing and record falsification. Final learner copy must remain aligned to facility/jurisdiction controls and preserve original evidence. Rebuild reference board in Drive: `course1-visual-blocker-rebuild-board-v1.png` (`1qzh2JHuHuIemiKktd-tLWw8XhWqpL4Lt`). |
...
The three original material blockers have been rebuilt as corrected review candidates. They are no longer blocked at the concept level, but they are still not public assets until final copy, accessibility and responsive QA passes.

- `06-CLEAN-DIRTY-FLOW v1` — superseded; corrected rebuild is the current review candidate.
- `07-SANITATION-SEQUENCE v1` — superseded; corrected rebuild is the current review candidate.
- `12-RECONCILIATION v1` — superseded; corrected rebuild is the current review candidate.
- Combined corrected reference: `course1-visual-blocker-rebuild-board-v1.png`, Drive ID `1qzh2JHuHuIemiKktd-tLWw8XhWqpL4Lt`.
...
- `06-CLEAN-DIRTY-FLOW`: use the corrected blocker-rebuild candidate.
- `07-SANITATION-SEQUENCE`: use the corrected blocker-rebuild candidate.
- `12-RECONCILIATION`: use the corrected blocker-rebuild candidate.

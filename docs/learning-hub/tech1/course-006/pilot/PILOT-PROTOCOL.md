# Pilot Protocol — Harvest, Postharvest, Traceability & Shift Handoff

**Course:** `COURSE-LH-TECH1-006`  
...
- exact course ID and version: `COURSE-LH-TECH1-006`;
- source commit SHA;
...
**Mapped performance evidence:** PRACTICAL-TECH1-F

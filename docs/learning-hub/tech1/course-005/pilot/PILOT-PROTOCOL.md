# Pilot Protocol — Propagation, Canopy, IPM Scouting & Crop Care

**Course:** `COURSE-LH-TECH1-005`  
...
- exact course ID and version: `COURSE-LH-TECH1-005`;
- source commit SHA;
...
**Mapped performance evidence:** PRACTICAL-TECH1-C / PRACTICAL-TECH1-D / PRACTICAL-TECH1-E

# Course 7 Rendered Accessibility & Learner UX Review

**Course:** `COURSE-LH-TECH2-007 — Traceability, Production Metrics, Shift Coordination & Peer Support`  
...
- responsive reflow does not clip tables, captions, assessment choices or action controls;

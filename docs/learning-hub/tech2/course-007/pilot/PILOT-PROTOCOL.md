# Pilot Protocol — Traceability, Production Metrics, Shift Coordination & Peer Support

**Course:** `COURSE-LH-TECH2-007`  
...
- exact course ID and version: `COURSE-LH-TECH2-007`;
- source commit SHA;

# Pilot Protocol — Integrated Technician II Simulation Lab

**Course:** `COURSE-LH-TECH2-008`  
...
- exact course ID and version: `COURSE-LH-TECH2-008`;
- source commit SHA;
...
**Mapped performance evidence:** PRACTICAL-TECH2-A through PRACTICAL-TECH2-G plus CAPSTONE-TECH2-SENIOR-TECHNICIAN-DIAGNOSTIC-SHIFT

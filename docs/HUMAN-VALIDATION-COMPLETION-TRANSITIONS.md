...
Occupational validation completion requires explicit technical curriculum, JTA, SME/employer, blueprint, and performance-validation confirmations plus current program/course locks.

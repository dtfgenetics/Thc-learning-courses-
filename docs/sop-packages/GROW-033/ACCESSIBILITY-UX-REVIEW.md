# GROW-033 Rendered Accessibility & Learner UX Review

**Package:** `GROW-033 — Seedling establishment`  
**Version:** `0.1.0`  
...
- scientific SOP: `docs/sop-packages/GROW-033/SCIENTIFIC-SOP-DRAFT.md`
- learner guide: `docs/sop-packages/GROW-033/LEARNER-GUIDE-DRAFT.md`
- implementation handoff: `docs/sop-packages/GROW-033/IMPLEMENTATION-HANDOFF.md`
- records template: `apps/web/public/downloads/sop-packages/grow-033-records-template.csv`

# GROW-130 Rendered Accessibility & Learner UX Review

**Package:** `GROW-130 — Harvest readiness and harvest workflow`  
**Version:** `0.1.0`  
...
- scientific SOP: `docs/sop-packages/GROW-130/SCIENTIFIC-SOP-DRAFT.md`
- learner guide: `docs/sop-packages/GROW-130/LEARNER-GUIDE-DRAFT.md`
- implementation handoff: `docs/sop-packages/GROW-130/IMPLEMENTATION-HANDOFF.md`
- records template: `apps/web/public/downloads/sop-packages/grow-130-records-template.csv`

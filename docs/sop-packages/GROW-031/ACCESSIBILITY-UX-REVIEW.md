# GROW-031 Rendered Accessibility & Learner UX Review

**Package:** `GROW-031 — Seed intake, labeling, and storage`  
**Version:** `0.1.0`  
...
- scientific SOP: `docs/sop-packages/GROW-031/SCIENTIFIC-SOP-DRAFT.md`
- learner guide: `docs/sop-packages/GROW-031/LEARNER-GUIDE-DRAFT.md`
- implementation handoff: `docs/sop-packages/GROW-031/IMPLEMENTATION-HANDOFF.md`
- records template: `apps/web/public/downloads/sop-packages/grow-031-records-template.csv`

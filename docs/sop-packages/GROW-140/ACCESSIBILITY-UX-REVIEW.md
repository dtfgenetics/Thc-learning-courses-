# GROW-140 Rendered Accessibility & Learner UX Review

**Package:** `GROW-140 — Drying, curing, storage, and water activity`  
**Version:** `0.1.0`  
...
- scientific SOP: `docs/sop-packages/GROW-140/SCIENTIFIC-SOP-DRAFT.md`
- learner guide: `docs/sop-packages/GROW-140/LEARNER-GUIDE-DRAFT.md`
- implementation handoff: `docs/sop-packages/GROW-140/IMPLEMENTATION-HANDOFF.md`
- records template: `apps/web/public/downloads/sop-packages/grow-140-records-template.csv`

# GROW-090 Rendered Accessibility & Learner UX Review

**Package:** `GROW-090 — Integrated pest management`  
**Version:** `0.1.0`  
...
- scientific SOP: `docs/sop-packages/GROW-090/SCIENTIFIC-SOP-DRAFT.md`
- learner guide: `docs/sop-packages/GROW-090/LEARNER-GUIDE-DRAFT.md`
- implementation handoff: `docs/sop-packages/GROW-090/IMPLEMENTATION-HANDOFF.md`
- records template: `apps/web/public/downloads/sop-packages/grow-090-records-template.csv`

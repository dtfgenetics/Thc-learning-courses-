# GROW-150 Rendered Accessibility & Learner UX Review

**Package:** `GROW-150 — Testing, QA, CAPA, and crop review`  
**Version:** `0.1.0`  
...
- scientific SOP: `docs/sop-packages/GROW-150/SCIENTIFIC-SOP-DRAFT.md`
- learner guide: `docs/sop-packages/GROW-150/LEARNER-GUIDE-DRAFT.md`
- implementation handoff: `docs/sop-packages/GROW-150/IMPLEMENTATION-HANDOFF.md`
- records template: `apps/web/public/downloads/sop-packages/grow-150-records-template.csv`

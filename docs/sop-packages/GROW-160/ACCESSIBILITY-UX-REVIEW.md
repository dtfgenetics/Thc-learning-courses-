# GROW-160 Rendered Accessibility & Learner UX Review

**Package:** `GROW-160 — Forms, logs, checklists, and training records`  
**Version:** `0.1.0`  
...
- scientific SOP: `docs/sop-packages/GROW-160/SCIENTIFIC-SOP-DRAFT.md`
- learner guide: `docs/sop-packages/GROW-160/LEARNER-GUIDE-DRAFT.md`
- implementation handoff: `docs/sop-packages/GROW-160/IMPLEMENTATION-HANDOFF.md`
- records template: `apps/web/public/downloads/sop-packages/grow-160-records-template.csv`

# GROW-040 Rendered Accessibility & Learner UX Review

**Package:** `GROW-040 — Growing media selection and preparation`  
**Version:** `0.1.0`  
...
- scientific SOP: `docs/sop-packages/GROW-040/SCIENTIFIC-SOP-DRAFT.md`
- learner guide: `docs/sop-packages/GROW-040/LEARNER-GUIDE-DRAFT.md`
- implementation handoff: `docs/sop-packages/GROW-040/IMPLEMENTATION-HANDOFF.md`
- records template: `apps/web/public/downloads/sop-packages/grow-040-records-template.csv`

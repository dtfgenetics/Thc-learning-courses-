# GROW-011 Rendered Accessibility & Learner UX Review

**Package:** `GROW-011 — Grow space setup`  
**Version:** `0.1.0`  
...
- scientific SOP: `docs/sop-packages/GROW-011/SCIENTIFIC-SOP-DRAFT.md`
- learner guide: `docs/sop-packages/GROW-011/LEARNER-GUIDE-DRAFT.md`
- implementation handoff: `docs/sop-packages/GROW-011/IMPLEMENTATION-HANDOFF.md`
- records template: `apps/web/public/downloads/sop-packages/grow-011-records-template.csv`

# GROW-020 Rendered Accessibility & Learner UX Review

**Package:** `GROW-020 — Biosecurity and clean workflow`  
**Version:** `0.1.0`  
...
- scientific SOP: `docs/sop-packages/GROW-020/SCIENTIFIC-SOP-DRAFT.md`
- learner guide: `docs/sop-packages/GROW-020/LEARNER-GUIDE-DRAFT.md`
- implementation handoff: `docs/sop-packages/GROW-020/IMPLEMENTATION-HANDOFF.md`
- records template: `apps/web/public/downloads/sop-packages/grow-020-records-template.csv`

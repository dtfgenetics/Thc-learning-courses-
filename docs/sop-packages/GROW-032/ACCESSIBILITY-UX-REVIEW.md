# GROW-032 Rendered Accessibility & Learner UX Review

**Package:** `GROW-032 — Germination`  
**Version:** `0.1.0`  
...
- scientific SOP: `docs/sop-packages/GROW-032/SCIENTIFIC-SOP-DRAFT.md`
- learner guide: `docs/sop-packages/GROW-032/LEARNER-GUIDE-DRAFT.md`
- implementation handoff: `docs/sop-packages/GROW-032/IMPLEMENTATION-HANDOFF.md`
- records template: `apps/web/public/downloads/sop-packages/grow-032-records-template.csv`

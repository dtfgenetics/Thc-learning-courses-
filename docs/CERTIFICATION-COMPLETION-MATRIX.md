...
| Downloads / assets | Twenty-three draft CSV learner tools, a searchable Academy Downloads view, course visual registries, controlled asset routes, 96 public SVG compatibility/review files, and 10 high-resolution lossless Course 2 WebP candidates | Download schema, Technician I/II support packs, SOP learner pack, registry mapping, safe metadata API, UI/file-route boundaries, raster-only production policy, and Course 2 candidate integrity/resolution QA are deterministic | The 10 Course 2 raster candidates remain fail-closed pending human factual/copy, accessibility and responsive review; the other 86 governed replacements remain to be produced; no SVG baseline may be retired before verified cutover | External controlled SOP packages cannot be represented until their source files are available | Raster backlog reporting and regression tests prevent Course 1-6 / Technician II visual policy from silently drifting back to SVG-as-production; Course 2 source/candidate SHA-256 and dimensions are recorded |
...
3. Complete human QA and verified cutover for the 10 produced Course 2 WebP candidates, then produce the remaining 86 governed raster replacements, including Technician II's 36 primary production visuals; SVG compatibility/review assets cannot be released as production visuals.

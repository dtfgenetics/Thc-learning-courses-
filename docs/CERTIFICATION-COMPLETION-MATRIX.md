...
3. Complete human QA and verified cutover for the 40 produced Technician I Courses 2-6 WebP candidates, then produce the remaining 56 governed raster replacements, including Course 1 and Technician II's 36 primary production visuals; SVG compatibility/review assets cannot be released as production visuals.

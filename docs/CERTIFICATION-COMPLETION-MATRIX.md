...
| Downloads / assets | Twenty-three draft CSV learner tools, a searchable Academy Downloads view, course visual registries, controlled asset routes, 96 public SVG compatibility/review files, and 76 high-resolution lossless WebP candidates across Technician I Courses 2-6 and all Technician II courses | Download schema, Technician I/II support packs, SOP learner pack, registry mapping, safe metadata API, UI/file-route boundaries, raster-only production policy, and candidate integrity/resolution QA are deterministic | All 76 produced raster candidates remain fail-closed pending human factual/copy, authority-boundary, accessibility and responsive review; the remaining 20 Course 1 replacements require bespoke high-resolution masters; no SVG baseline may be retired before verified cutover | External controlled SOP packages cannot be represented until their source files are available | Raster backlog reporting and regression tests prevent Course 1-6 / Technician II visual policy from silently drifting back to SVG-as-production; source/candidate SHA-256, dimensions, encoding and byte counts are recorded |
...
3. Complete human QA and verified cutover for the 76 produced Technician I Courses 2-6 and Technician II WebP candidates, then create the remaining 20 bespoke Course 1 high-resolution masters; SVG compatibility/review assets cannot be released as production visuals.

...
record.technicalCurriculumReview={...record.technicalCurriculumReview,allCurrentCourseVersionsReviewed:true,contentScopeAndRoleBoundariesReviewed:true,scientificTechnicalConcernsResolvedOrDispositioned:true,reviewerCount};
record.jobTaskAnalysis={...record.jobTaskAnalysis,validated:true,populationDefined:true,taskDomainCoverageReviewed:true,currencyReviewed:true};
...
record.evidenceRefs=[...new Set([...(source.evidenceRefs??[]),source.id])];record.limitations=[...(source.limitations??[]),'Evidence-complete does not itself constitute final program approval or credential authorization.'];

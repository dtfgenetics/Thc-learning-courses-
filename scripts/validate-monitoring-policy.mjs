...
const worker = fs.readFileSync('scripts/certification-production-worker.mjs', 'utf8');
const failures = [];
...
if (!worker.includes('credential')) failures.push('credential worker source is unavailable for failure monitoring');

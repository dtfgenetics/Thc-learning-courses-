...
assert.equal(readiness.areas.curriculum.gates.scientificReviewComplete,true,'owner catalog attestation completes scientific review for the bound snapshot');
assert.equal(readiness.areas.curriculum.gates.editorialReviewComplete,true,'owner catalog attestation completes editorial review for the bound snapshot');
assert.equal(readiness.areas.assessment.gates.humanAssessmentReviewComplete,true,'owner catalog attestation completes assessment review for the bound snapshot');

# THC Academy project scope

## North star

THC / Teaching Healthy Cultivation is being built as a cannabis cultivation university + trade school + scientific knowledge base + performance-assessment system + credential platform + workforce/employer ecosystem.

A credential should answer an employer:

- What can this person do?
- At what proficiency?
- How was it assessed?
- Was performance demonstrated?
...
**Technician I:** execute, observe, measure, record, escalate.
...
Prestige is earned through demonstrable quality and adoption rather than marketing language. Build toward:

- strong science and evidence traceability;
- job-task relevance;
- realistic assessments;
- practical performance evidence;
- employer-readable competency records;
- public credential verification;
- work-based learning;
- employer/college relationships;
- accessible instruction;
- transparent outcome evidence;
- ASTM/ANAB and other appropriate standards alignment as a later external trust layer.

Accreditation and external recognition should strengthen the Academy, not freeze ordinary content production.
